 ...
 * );
 */
$config['recipients'] = 'norbert@eruncoach.com';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = array('norbert@eruncoach.com'=> 'eRun Coach');
 ...
 */
$config['subject'] = 'Submission from eRun Coach';
 ...
 */
$config['from'] = array('admin@eruncoach.com'=> 'eRun Coach');
...
echo $response;
 ...
 // recaptcha
$recaptcha = new Quform_Element('recaptcha_response_field', 'reCAPTCHA');
$recaptcha->addValidator('required');
$recaptcha->addValidator('recaptcha', array('privateKey' => '6LcBgOgSAAAAAHgISwWKhGQXfuOzb_4kk5CHQ9SI'));
